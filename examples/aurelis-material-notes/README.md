...
The complete React source for the material magazine shown in the [Satzstrom gallery](https://satzstrom.com/examples).
...
satzstrom init aurelis-material-notes --example aurelis-material-notes
cd aurelis-material-notes
satzstrom dev document.tsx --data data.json
```

To add this example to an existing project, run `satzstrom add aurelis-material-notes.tsx --example aurelis-material-notes` there. The CLI prints the document and data paths to use.
