...
The complete React source for the invoice shown in the [Satzstrom gallery](https://satzstrom.com/examples).
...
To add this example to an existing project, run `satzstrom add invoice.tsx --example invoice` there. The CLI prints the document and data paths to use.
