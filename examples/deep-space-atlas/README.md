...
The complete React source for the space atlas shown in the [Satzstrom gallery](https://satzstrom.com/examples).
...
satzstrom init deep-space-atlas --example deep-space-atlas
cd deep-space-atlas
satzstrom dev document.tsx --data data.json
```

To add this example to an existing project, run `satzstrom add deep-space-atlas.tsx --example deep-space-atlas` there. The CLI prints the document and data paths to use.
